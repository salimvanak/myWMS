        ...
        <f:view locale="#{ReplenishBean.locale}">
            ...
            <h:form id="Form" styleClass="form" >
                ...
                <p id="pHeader"class="pageheader">
                	<h:outputText id="pagetitle" value="#{bundle.TitleSourceConfirm}" styleClass="pagetitle"/>
                ...
                <div class="buttonbar">  
                    <h:commandButton id="BUTTON_OK" 
	                				 value="#{bundle.ButtonCompleteUnitLoad}" 
	                				 action="#{ReplenishBean.processSourceConfirm}" 
	                				 styleClass="commandButton"  />
	                				 
					&#160;
                    <h:commandButton id="BUTTON_CHANGE" 
	                				 value="#{bundle.ButtonPartialAmount}" 
	                				 action="#{ReplenishBean.processSourceConfirmChange}" 
	                				 styleClass="commandButton"  />
                </div>
