            ...
            <h:form id="Form" styleClass="form" >
                ...
                <div class="space">
                    ...
                    <table  width="100%" border="0" cellspacing="0">
                    	...
                    	<tr>
                            <td nowrap="nowrap" style="padding-right:20px;padding-top:5px;">
                            	<h:outputLabel id="matLabel" value="Artikel:" styleClass="param"/> 
                            </td>
                    ...
                    <table  width="100%" border="0" cellspacing="0" style="padding-top:10px;">
                    	...
                    	<tr>
                            ...
                            <td nowrap="nowrap">
                              	<h:outputLabel id="amount2Data" value="#{ReplenishBean.amountPicked} #{ReplenishBean.itemUnit}" styleClass="label"/>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table  width="100%" border="0" cellspacing="0" style="padding-top:15px;">
                        <tr>
                            <td>
                            	<h:outputLabel id="input1Label" value="#{bundle.LabelEnterTargetLocation}" styleClass="label" />
                            </td>
                        </tr><tr>
                            <td>
                ...
                <div class="buttonbar">  
                    <h:commandButton id="BUTTON_CONTINUE" 
	                				 ...
	                				 action="#{ReplenishBean.processDestinationLocation}" 
	                				 styleClass="commandButton"  />
					&#160;
                    <h:commandButton id="BUTTON_SPECIAL" 
	                				 value="#{bundle.ButtonCancel}" 
	                				 action="#{ReplenishBean.processDestinationLocationCancel}" 
	                				 styleClass="commandButton"  />
                </div>
            </h:form>
        </f:view> 
