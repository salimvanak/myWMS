    ...
    <body class="verticalscroll" topmargin="0" leftmargin="0" marginwidth="0" marginheight="0" onload="load()">
        <f:view locale="#{ShippingBean.locale}">
            ...
            <h:form id="Form" styleClass="form" >
                <%-- Page Title--%>
                <p class="pageheader">
                	<h:outputText id="pagetitle" value="#{bundle.TitleInfo}" styleClass="pagetitle"/>
                ...
                <div class="space">
                    ...
                    <table  width="100%" border="0" cellspacing="0">
                        ...
                        <tr>
                            <td>
                                <h:outputText value="#{bundle.LabelComment}:" styleClass="param"/>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" style="padding-left:20px; font-size:smaller;">
                               	<h:outputLabel id="comment" value="#{ShippingBean.comment}" styleClass="value" />
                            </td>
                ...
                <div class="buttonbar">  
	                    <h:commandButton id="BUTTON_CONTINUE" 
		                				 value="#{bundle.LabelBack}" 
		                				 action="#{ShippingBean.processShowUnitLoad}" 
