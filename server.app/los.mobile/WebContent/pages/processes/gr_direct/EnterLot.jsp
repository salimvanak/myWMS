        ...
        <f:view locale="#{GRDirectBean.locale}">	
            ...
            <h:form id="Form" styleClass="form" >
                ...
                <p id="pHeader" class="pageheader">
                	<h:outputText id="pagetitle" value="#{bundle.TitleEnterLot}" styleClass="pagetitle"/>
                ...
                <div class="space">
                    ...
                    <table  width="100%" border="0" cellspacing="0">
                    	...
                    	<tr>
                            <td nowrap="nowrap" style="padding-right:20px">
                            	<h:outputLabel id="paramAmount" value="#{bundle.LabelAmount}:" styleClass="param" rendered="#{GRDirectBean.showOrder}" /> 
                            </td>
                            <td nowrap="nowrap">
                              	<h:outputLabel id="dataAmount" value="#{GRDirectBean.amountPos}" styleClass="label" rendered="#{GRDirectBean.showOrder}" />
                            </td>
                        </tr>
                        
                    	<tr>
                            <td nowrap="nowrap" style="padding-right:20px">
                            	<h:outputLabel id="paramLot" value="#{bundle.LabelLot}:" styleClass="param" rendered="#{GRDirectBean.adviceLot != null}" /> 
                            </td>
                            <td nowrap="nowrap">
                              	<h:outputLabel id="dataLot" value="#{GRDirectBean.adviceLot}" styleClass="label" rendered="#{GRDirectBean.adviceLot != null}" />
                            </td>
                        </tr>
                    ...
                    <table  width="100%" border="0" cellspacing="0">
                        ...
                        <tr>
                            <td>
                            	<h:outputLabel id="input1Label" value="#{bundle.LabelEnterLot}" styleClass="label" />
                            </td>
                        </tr><tr>
                            <td>
                               	<h:inputText id="input1" 
                             			 value="#{GRDirectBean.inputLotName}" 
                             			 styleClass="input" /> 
                            </td>
                        </tr>
                ...
                <div class="buttonbar">  
	                 <h:commandButton id="forwardButton" 
	                 				 ...
	                 				 action="#{GRDirectBean.processEnterLot}" 
	                 				 styleClass="commandButton"  />
	                 				 
	                 <h:commandButton id="backButton" 
	                 				 value="#{bundle.ButtonCancel}" 
	                 				 action="#{GRDirectBean.processEnterLotCancel}" 
	                 				 styleClass="commandButton"  />
                </div>
