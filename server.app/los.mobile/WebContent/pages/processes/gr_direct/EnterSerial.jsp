            ...
            <h:form id="Form" styleClass="form" >
                ...
                <div class="space">
                    ...
                    <table  width="100%" border="0" cellspacing="0">
                    	...
                    	<tr>
                            <td nowrap="nowrap" style="padding-right:20px">
                            	<h:outputLabel id="paramAmount" value="#{bundle.LabelAmount}:" styleClass="param"/> 
                            </td>
                            <td nowrap="nowrap">
                    ...
                    <table  width="100%" border="0" cellspacing="0">
                        ...
                        <tr>
                            <td>
                            	<h:outputLabel id="input1Label" value="#{bundle.LabelEnterSerial}" styleClass="label" />
                            </td>
                        </tr><tr>
                            <td>
                ...
                <div class="buttonbar">  
	                 <h:commandButton id="forwardButton" 
	                 				 ...
	                 				 action="#{GRDirectBean.processEnterSerial}" 
	                 				 styleClass="commandButton"  />
	                 				 
	                 <h:commandButton id="backButton" 
	                 				 value="#{bundle.ButtonCancel}" 
	                 				 action="#{GRDirectBean.processEnterSerialCancel}" 
	                 				 styleClass="commandButton"  />
                </div>
