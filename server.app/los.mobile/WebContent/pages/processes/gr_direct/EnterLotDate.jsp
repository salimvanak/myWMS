        ...
        <f:view locale="#{GRDirectBean.locale}">	
            ...
            <h:form id="Form" styleClass="form" >
                ...
                <p id="pHeader" class="pageheader">
                	<h:outputText id="pagetitle" value="#{bundle.TitleEnterLotDate}" styleClass="pagetitle"/>
                ...
                <div class="space">
                    ...
                    <table  width="100%" border="0" cellspacing="0">
                    	...
                    	<tr>
                            <td nowrap="nowrap" style="padding-right:20px">
                            	<h:outputLabel id="paramLot" value="#{bundle.LabelLot}:" styleClass="param" /> 
                            </td>
                            <td nowrap="nowrap">
                              	<h:outputLabel id="dataLot" value="#{GRDirectBean.lot}" styleClass="label" />
                            </td>
                        </tr>
                    ...
                    <table  width="100%" border="0" cellspacing="0">
	            		...
	            		<tr>
	            			<td>
								<h:outputLabel id="labelMsg1" value="#{bundle.LabelConfirmLot}" styleClass="label" />
	            			</td>
	            		</tr>
                        ...
                        <tr>
                            <td>
                            	<h:outputLabel id="input1Label" value="#{bundle.LabelEnterLotDate}" styleClass="label" />
                            </td>
                        </tr>
                ...
                <div class="buttonbar">  
	                 <h:commandButton id="forwardButton" 
	                 				 ...
	                 				 action="#{GRDirectBean.processEnterLotDate}" 
	                 				 styleClass="commandButton"  />
	                 				 
	                 <h:commandButton id="backButton" 
	                 				 value="#{bundle.ButtonBack}" 
	                 				 action="#{GRDirectBean.processEnterLotDateCancel}" 
	                 				 styleClass="commandButton"  />
                </div>
