...
<html>
    ...
    <body class="verticalscroll" topmargin="0" leftmargin="0" marginwidth="0" marginheight="0" onload="load()">
        <f:view locale="#{GRDirectBean.locale}">	
            ...
            <h:form id="Form" styleClass="form" >
                ...
                <p id="pHeader" class="pageheader">
                	<h:outputText id="pagetitle" value="#{bundle.TitleEnterUlType}" styleClass="pagetitle"/>
                    ...
                    <table  width="100%" border="0" cellspacing="0">
                        ...
                        <tr>
                            <td style="margin-left:5px">
                            	<h:outputLabel id="validToLabel" value="#{bundle.LabelEnterUlType}" styleClass="label" />
                            </td> 
                        </tr>
                        <tr>
                            <td style="margin-left:5px;">
                ...
                <div class="buttonbar">  
	                 <h:commandButton id="forwardButton" 
	                 				 ...
	                 				 action="#{GRDirectBean.processEnterUlType}" 
	                 				 styleClass="commandButton"  />
	                 				 
	                 <h:commandButton id="backButton" 
	                 				 value="#{bundle.ButtonCancel}" 
	                 				 action="#{GRDirectBean.processEnterUlTypeCancel}" 
	                 				 styleClass="commandButton"  />
	                 				 
	                 <h:commandButton id="addtoButton" 
	                 				 value="#{bundle.ButtonAddToUl}" 
	                 				 action="#{GRDirectBean.processEnterUlTypeAdd}" 
	                 				 styleClass="commandButton" 
        ...
        <script type="text/javascript">
            ...
            function setFocus() {
                document.getElementById('Form:forwardButton').focus();
            }    
