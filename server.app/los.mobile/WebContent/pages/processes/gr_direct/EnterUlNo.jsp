        ...
        <f:view locale="#{GRDirectBean.locale}">	
            ...
            <h:form id="Form" styleClass="form" >
                ...
                <p id="pHeader" class="pageheader">
                	<h:outputText id="pagetitle" value="#{bundle.TitleEnterUlNo}" styleClass="pagetitle"/>
                ...
                <div class="space">
                    ...
                    <table  width="100%" border="0" cellspacing="0">
                        ...
                        <tr>
                            <td>
                            	<h:outputLabel id="input1Label" value="#{bundle.LabelEnterUlNo}" styleClass="label" />
                            </td>
                        </tr><tr>
                            <td>
                ...
                <div class="buttonbar">  
	                 <h:commandButton id="forwardButton" 
	                 				 ...
	                 				 action="#{GRDirectBean.processEnterUlNo}" 
	                 				 styleClass="commandButton"  />
	                 				 
	                 <h:commandButton id="backButton" 
	                 				 value="#{bundle.ButtonCancel}" 
	                 				 action="#{GRDirectBean.processEnterUlNoCancel}" 
	                 				 styleClass="commandButton"  />

	                 <h:commandButton id="addtoButton" 
	                 				 value="#{bundle.ButtonAddToUl}" 
	                 				 action="#{GRDirectBean.processEnterUlNoAdd}" 
	                 				 styleClass="commandButton" 
