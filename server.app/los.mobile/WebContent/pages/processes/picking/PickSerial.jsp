        ...
        <f:view locale="#{PickingBean.locale}">
            ...
            <h:form id="Form" styleClass="form" onsubmit="return validate();">
                ...
                <p id="pHeader"class="pageheader">
                	<h:outputText id="pagetitle" value="#{bundle.TitleEnterSerial}" styleClass="pagetitle"/>
                ...
                <div class="space">
                    ...
                    <table  width="100%" border="0" cellspacing="0">
                    	...
                    	<tr>
                            ...
                            <td nowrap="nowrap">
                              	<h:outputLabel id="amountData" value="#{PickingBean.serialInfo}" styleClass="labelBold"/>
                            </td>
                        </tr>
                  	</table>
                </div>
                ...
                <div class="space" style="padding-top:10px; padding-bottom:10px">
                   	<h:outputLabel id="msgLabel" value="#{bundle.MsgSerial}" styleClass="infoSmall"/> 
               	</div>
                    ...
                    <table  width="100%" border="0" cellspacing="0">
                        <tr>
                            <td nowrap="nowrap" colspan="2">
                            	<h:outputLabel id="input1Label" value="#{bundle.MsgEnterSerial}" styleClass="label" />
                            </td>
                        </tr>
                        <tr>
                            <td>
