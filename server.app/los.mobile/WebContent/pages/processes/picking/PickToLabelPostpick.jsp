        ...
        <f:view locale="#{PickingBean.locale}">
            ...
            <h:form id="Form" styleClass="form" >
                ...
                <p id="pHeader"class="pageheader">
                	<h:outputText id="pagetitle" value="#{bundle.TitlePrint}" styleClass="pagetitle"/>
                ...
                <div class="space">
                    <table  width="100%" border="0" cellspacing="0">
                        ...
                        <tr>
                            <td>
                            	<h:outputLabel id="input1Label" value="#{bundle.MsgPrint}" styleClass="label" />
                            </td>
                        </tr><tr>
                            <td>
                ...
                <%-- Command Buttons --%>
                <div class="buttonbar">  
                    <h:commandButton id="BUTTON_PRINT" 
	                				 value="#{bundle.ButtonPrint}" 
	                				 action="#{PickingBean.processPickToLabelPrint}" 
	                				 styleClass="commandButton"  />
					&#160;
                    <h:commandButton id="BUTTON_GENERATE" 
	                				 value="#{bundle.ButtonGenerateLabel}" 
	                				 action="#{PickingBean.processPickToLabelGenerate}" 
	                				 styleClass="commandButton"  />
