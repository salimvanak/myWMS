        ...
        <f:view locale="#{PickingBean.locale}">
            ...
            <h:form id="Form" styleClass="form" onsubmit="return validate();">
                ...
                <p id="pHeader"class="pageheader">
                	<h:outputText id="pagetitle" value="#{bundle.TitleEnterAmountRemaining}" styleClass="pagetitle"/>
                    ...
                    <table  width="100%" border="0" cellspacing="0">
                        ...
                        <tr>
                            <td nowrap="nowrap" colspan="2">
                            	<h:outputLabel id="input1Label" value="#{bundle.MsgEnterRemainingAmount}" styleClass="label" />
                            </td>
                        </tr><tr>
                            <td width="80%">
                ...
                <div class="buttonbar">  
                    <h:commandButton id="BUTTON_CONTINUE" 
	                				 ...
	                				 action="#{PickingBean.processPickRemaining}" 
                                     onclick="noticeButton()"
	                				 styleClass="commandButton"  />
					&#160;
                    <h:commandButton id="BUTTON_SKIP" 
	                				 value="#{bundle.ButtonCancel}" 
	                				 action="#{PickingBean.processPickRemainingCancel}" 
                                     onclick="noticeButton()"
	                				 styleClass="commandButton"  />
                </div>
            </h:form>
