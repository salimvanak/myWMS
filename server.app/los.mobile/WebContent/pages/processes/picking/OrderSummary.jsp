        ...
        <f:view locale="#{PickingBean.locale}">
            ...
            <h:form id="Form" styleClass="form" >
                ...
                <p id="pHeader"class="pageheader">
                	<h:outputText id="pagetitle" value="Pick: Auftragsübersicht" styleClass="pagetitle"/>
                ...
                <div class="space">
                    <h:messages id="messages"  styleClass="error"/> 
                  	...
                  	<h:outputText escape="false" value="#{PickingBean.orderSummary}" styleClass="param"/> 
                ...
                <div class="buttonbar">  
                    <h:commandButton id="BUTTON_CONTINUE" 
	                				 ...
	                				 action="#{PickingBean.processOrderSummary}" 
	                				 styleClass="commandButton"  />
					&#160;
                    <h:commandButton id="BUTTON_CANCEL" 
	                				 value="#{bundle.ButtonCancel}" 
	                				 action="#{PickingBean.processOrderSummaryCancel}" 
	                				 styleClass="commandButton"  />
                </div>
            </h:form>
        </f:view> 
