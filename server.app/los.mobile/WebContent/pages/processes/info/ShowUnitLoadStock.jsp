        ...
        <f:view locale="#{InfoBean.locale}">
            ...
            <h:form id="Form" styleClass="form" >
                ...
                <p id="pHeader"class="pageheader">
                	<h:outputText id="pagetitle" value="#{bundle.TitleShowUnitLoadStock}" styleClass="pagetitle"/>
                ...
                <div class="space">
                    ...
                    <table  width="100%" border="0" cellspacing="0">
                    	...
                    	<tr>
                            <td nowrap="nowrap" style="padding-right:20px">
                            	<h:commandLink id="unitLoadLabel" value="#{bundle.LabelUnitLoad}:" action="#{InfoBean.processUnitLoadUnitLoad}" />
                            </td>
                            <td nowrap="nowrap">
                    	...
                    	<tr>
                            <td nowrap="nowrap" style="padding-right:20px">
                            	<h:commandLink id="pickLabel" value="#{InfoBean.unitLoadOrderLabel}:" action="#{InfoBean.processUnitLoadStockOrder}" disabled="#{!InfoBean.unitLoadHasOrderContent}" />
                            </td>
                            <td nowrap="nowrap">
