...
<html>
    ...
    <body class="verticalscroll" topmargin="0" leftmargin="0" marginwidth="0" marginheight="0" onload="load()">
            ...
            <h:form id="Form" styleClass="form" >
                ...
                <div class="space">
                    ...
                    <table  width="100%" border="0" cellspacing="0">
                        ...
                        <tr>
                            <td>
                            	<h:outputLabel id="serailLabel" value="#{bundle.LabelEnterSerial}" styleClass="label" />
                            </td>
                        </tr><tr>
                            <td>
								<h:inputText id="serialTextField" value="#{StockTakingBean.currentSerial}" styleClass="input" />
                            </td>
                        </tr>
                ...
                <div class="buttonbar">  
		                    <h:commandButton id="BUTTON_CONTINUE" 
			                				 ...
			                				 action="#{StockTakingBean.newSerial}" 
        ...
        <script type="text/javascript">
            ...
            function setFocus() {
                document.getElementById('Form:serialTextField').focus();
            }    
