        ...
        <f:view locale="#{StockTakingBean.locale}">
            ...
            <h:form id="Form" styleClass="form" >
                ...
                <p id="pHeader"class="pageheader">
	                <h:outputText id="pagetitle" value="#{bundle.TitleConfirmStockMissing}" styleClass="pagetitle"/>
                ...
                <div class="space">
                        ...
                        <tr>
                            <td nowrap="nowrap" style="padding-right:20px">
                            	<h:outputLabel id="unitLoadListLabel" 
                            				   value="#{bundle.LabelMissingStocks_}" 
                            				   styleClass="param" /> 
                            </td>
                            <td nowrap="nowrap">
                            	<h:outputLabel id="unitLoadList" 
                            				   value="#{StockTakingBean.missingStocks}" 
                            				   styleClass="value" /> 
                            </td>
                        </tr>
                        <tr><td>&#160;</td></tr>
                    ...
                    <p class="info">                    
	                    <h:outputLabel value="#{bundle.TextMissingStock1}"/>
	                </p>
	                <h:outputLabel value="#{bundle.TextMissingStock2}" styleClass="labelBold"/>
                </div>
                ...
                <div class="buttonbar">  
		                    <h:commandButton id="BUTTON_CONFIRM" 
			                				 ...
			                				 action="#{StockTakingBean.confirmStocksMissing}" 
			                				 styleClass="commandButton"  />
		                    <h:commandButton id="BUTTON_NOCONFIRM" 
		                    				 value="#{bundle.ButtonNo}" 
		                    				 action="#{StockTakingBean.cancelStocksMissing}" 
		                    				 styleClass="commandButton"  />
                </div>
            </h:form>
        </f:view> 
