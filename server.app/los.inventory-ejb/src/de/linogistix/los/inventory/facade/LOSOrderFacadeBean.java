...
public class LOSOrderFacadeBean implements LOSOrderFacade {
	...
	public void changeOrderPrio( String orderNumber, int prio ) throws FacadeException {
		...
		log.debug(logStr+"order="+orderNumber);
		...
		changeOrderPrio(order.getId(), prio);
	}
	...
	public Document generateReceipt( String orderNumber, boolean save ) throws FacadeException {
