...
@Local
public interface LOSInventoryComponent extends BasicFacade{
	...
	List<LogItem> sanityCheckStockUnit();
	List<LogItem> sanityCheckGoodsReceiptPosition();
	List<LogItem> sanityCheckAdviceReassign();
