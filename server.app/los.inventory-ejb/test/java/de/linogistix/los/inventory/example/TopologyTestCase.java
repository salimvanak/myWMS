...
public class TopologyTestCase extends TestCase {
	...
	public TopologyTestCase(String testName) {
		super(testName);
	}

	public TopologyTestCase() {
	}

	@BeforeClass
	public static void createTopologyAndBeans() throws Exception {
	...
	@AfterClass
	public static void cleanUpTopology() throws Exception {
